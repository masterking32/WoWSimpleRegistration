...
$language['create_account_tip3'] = 'Откройте директорию "World of Warcraft". Директория по умолчанию - "C:\Program Файлы\World of Warcraft". Когда вы нашли её, откройте директорию под названием "Data", затем перейдите в директорию под названием enUS или enGB, в зависимости от языка вашего клиента.';
